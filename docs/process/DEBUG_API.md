...
| `exploreRenderStats()` | `{ drawCalls, triangles, geometries, textures }`, ou `null` | compteurs Three/WebGL de la dernière image d'exploration, pour mesurer L7 sur un matériel et un parcours documentés ; hors exploration, renvoie `null` |
