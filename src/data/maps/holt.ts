...
const ENTITIES: EntityDef[] = [
  ...
  },
  {
    ...
    type: 'npc',
    cell: { x: 40, y: 4 },
    line: 'Un cadet enfile ses bottes en retard, pestant contre le réveil.',
    label: 'Regarder le cadet',
    condition: etape('reveil'),
  },
  {
    ...
    type: 'npc',
    cell: { x: 45, y: 8 },
    line: 'Une cadette plie sa couverture au carré, sans un regard pour le reste du dortoir.',
    label: 'Regarder la cadette',
    condition: etape('reveil'),
  },
  ...
  // -- Couloirs (1 -> 2 : le flux vers la cantine) -----------------------
  {
    ...
    type: 'npc',
    cell: { x: 23, y: 9 },
    line: 'Un cadet presse le pas, sac encore ouvert.',
    label: 'Regarder le cadet',
    condition: etape('reveil'),
  },
  {
    ...
    type: 'npc',
    cell: { x: 23, y: 11 },
    line: 'Deux cadettes filent vers la cantine sans se retourner.',
    label: 'Regarder les cadettes',
    condition: etape('reveil'),
  },
  ...
  // -- Cantine (étape 2 · Discours) --------------------------------------
  {
    ...
    type: 'npc',
    cell: { x: 43, y: 15 },
    line: "Le directeur balaie la salle du regard, debout sur l'estrade, jusqu'à ce que le silence soit total.",
    label: 'Observer le directeur',
    condition: etape('reveil'),
  },
  {
  ...
  },
  {
    ...
    type: 'npc',
    cell: { x: 41, y: 18 },
    line: 'Abraham compte et recompte les rangs du regard.',
    label: 'Regarder Abraham',
    condition: etape('reveil'),
  },
  {
    ...
    type: 'npc',
    cell: { x: 45, y: 22 },
    line: 'Betty griffonne quelque chose sur sa manche.',
    label: 'Regarder Betty',
    condition: etape('reveil'),
  },
  {
    ...
    type: 'npc',
    cell: { x: 47, y: 26 },
    line: 'Calvin bâille sans se cacher.',
    label: 'Regarder Calvin',
    condition: etape('reveil'),
  },
  ...
  },
  {
    ...
    type: 'npc',
    cell: { x: 34, y: 24 },
    line: 'Theodore ajuste ses lunettes rondes et hoche la tête à ce que dit Grover.',
    label: 'Regarder Theodore',
    condition: etape('temps-libre'),
  },
  ...
  },
  {
    ...
    type: 'npc',
    cell: { x: 32, y: 33 },
    line: 'Woodrow relit sa copie en se mordant la lèvre.',
    label: 'Regarder Woodrow',
    condition: etape('examen'),
  },
  {
    ...
    type: 'npc',
    cell: { x: 44, y: 39 },
    line: 'Nancy a déjà fini ; elle regarde le plafond.',
    label: 'Regarder Nancy',
    condition: etape('examen'),
  },
  {
